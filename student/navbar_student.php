...
<head>
    ...
    <title>Student Project Face Recognition</title>
</head>
<body>
<div class="container-fluid navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <nav class="navbar-nav mr-auto collapse navbar-collapse row">
              ...
              <li class="nav-item col-lg-2"><a href="register.php" class="nav-link text-light"><i class="fas fa-plus"></i> ผลการลงทะเบียน</a></li>
              <li class="nav-item dropdown col-lg-2">
                  ...
                  <div class="dropdown-menu">
                      <a href="student_account.php" class="dropdown-item">บัญชีผู้ใช้</a>

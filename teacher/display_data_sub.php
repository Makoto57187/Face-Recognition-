...
<?php
    ...
    <H1>ข้อมูลรายวิชา subname$</H1><br>
        ...
        <div class=\"form-row\">
           ...
           <input type=\"text\" name=\"sub_id\" class=\"col-4 form-control-sm my-2\" value=\"946-112\" readonly><br>
        </div>
        <div class=\"form-row\">
           <label class=\"col-sm-2 col-form-label col-form-label text-right my-2\">ชื่อวิชา</label>
           <input type=\"text\" name=\"sub_name\" class=\"col-4 form-control-sm my-2\" value=\"Example Course\" readonly ><br>
        </div>
        <div class=\"form-row\">
        ...
        <div class\"row\">
            ...
            <input type=\"submit\" name=\"submit\" value=\"แก้ไขข้อมูลรายวิชา\" class=\"btn btn-dark col-sm-4\" >
        </div>
           </form>
           </fieldset>
     </div>";
